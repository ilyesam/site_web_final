...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) { /////////////////insertion rdv 
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="form-group">
                                     <label>Nom </label>
                                            <input class="form-control" required="required" pattern="[a-zA-Z]*[\s]*[a-zA-Z]*[\s]*[a-zA-Z]*" placeholder=" Entrez le Nom du patient " name="nom_p">
                                    </div>
                                    
                                      <div class="form-group">
                                     <label>Prénom </label>
                                            <input class="form-control" required="required" pattern="[a-zA-Z]*[\s]*[a-zA-Z]*[\s]*[a-zA-Z]*" placeholder=" Entrez le Prénom du patient " name="prenom_p">
                                    </div>
                                     ...
                                     <label>Téléphone </label>
                                        <input class="form-control" required="required" pattern="^(0[5-7][0-9]{8})$" placeholder=" Entrez le n° de Téléphone " name="tel_p">
                                    </div>
                              
                                    
                                      <div class="form-group">
                                     <label>Date & heure de RDV </label>
