...
{
 Redirect($Str_Location = "../index.php?id=".$row_["id"], $Bln_Replace = 1, $Int_HRC = NULL); ////////////verification connection 
}



$query_p = " SELECT * FROM patient , dosssier_medical where dosssier_medical.id_p = patient.id_p and id_m like ".$id; 
$p = $pdo->query($query_p);   ///////////// liste patient 
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header" id="st">Gestion des patients</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h3 id="st">Liste des Patients</h3>
			...
			<tbody> 
              ...
              <?php $i = 1; while($row_p = $p->fetch(PDO::FETCH_ASSOC)) : ?>  
				...
				<tr> 
    				...
    				<td><?php echo $row_p['nom_p']; ?></td> 
                    
                    	<td><?php echo $row_p['prenom_p']; ?></td> 
    			<td><?php echo $row_p['tel_p']; ?></td> 
            	<td><?php echo $row_p['email_p']; ?></div>
<td> <a href="dossier_medical_m.php?nom=<?php echo $row_p['nom_p']." ".$row_p['prenom_p']."&&id_p=".$row_p['id_p']."&&id=".$_GET["id"]."&&idc=".$_GET["idc"]; ?> " >  <i class="fa fa-eye fa-2x"> </i>  </a>  
                	</div>
                            </td>
