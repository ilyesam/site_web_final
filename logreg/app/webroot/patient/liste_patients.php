...
$query_p = " select * from patient where  id_p like  ".$id;   ////////// recuperer coordonnées patient 
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header" id="st">Information sur le patient</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
