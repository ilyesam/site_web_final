...
<head>
	...
	<title>Accueil_cabinet_M&eacute;dical</title>
...
.mon{
	background-image: url(img/196980048_831613491073803_6236869903718280316_n.jpg);
...
<body data-mobile-nav-trigger-alignment="right" data-mobile-nav-align="left" data-mobile-nav-style="modern" data-mobile-nav-shceme="gray" data-mobile-header-scheme="gray" data-mobile-nav-breakpoint="1199" style="overflow: visible;">
	...
	<!-- page principal menu  -->				
										...
										<br>
											<a href="inscription_medecin.php" id="signup_medecin_button">
												...
												<span class="link-txt">
													<span class="link-ext"></span>
													<span class="txt" style="color:white;">Vous ?tes m?decin?</span>												</span>											</a>							</div><!-- /#main-header-collapse -->
						</div><!-- /.col -->
						<!--Partie mobile fin-->
	...
	<!-- page principal recherche medecin  -->					<form id="search_form" name="search_form" autocomplete="off" method="GET" action="recherche.php">
										<div id="custom-search-input">
                                      	...
                                      	<div class="form-inline">
											  ...
											  <table width=1200" border="none" align="center">
                                              <tr>
                                                    <th width="600" scope="col">     <div align="center">
                                                      <input id="input_query" type="text" class="form-control search-query ui-autocomplete-input" title="Médecin, Spécialité, Spécialisation ...." placeholder="Médecin, Spécialité, ...." name="s" required="" autocomplete="off">  
                                                      <input class="btn btn-solid text-uppercase circle btn-bordered border-thin font-size-14 font-weight-semibold" type="submit"  id="btn_search" value="Trouver">
                                                    </div></th>
                                                  </tr>
                                                </table>
                                              </form>
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2624.613884825835!2d2.369826551035776!3d48.865572779186586!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e66dfcb597ba27%3A0x76cc3b70437a512f!2s36%20Avenue%20de%20la%20R%C3%A9publique%2C%2075011%20Paris%2C%20France!5e0!3m2!1sfr!2sdz!4v1623164871770!5m2!1sfr!2sdz" width="100%" height="650" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
