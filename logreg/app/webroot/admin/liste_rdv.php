...
$query_p = " SELECT * FROM rdv, medecin where rdv.id_m = medecin.id_med   order by id_rdv desc "; 
$p = $pdo->query($query_p);
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h2 class="page-header" id="st">Gestion des rendez-vous</h2>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h3 id="st">Liste des Rendez-vous</h3>
