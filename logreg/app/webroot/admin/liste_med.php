...
$query_p = " SELECT * FROM  medecin  order by id_med desc "; 
$p = $pdo->query($query_p);
            ...
            <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <h3 id="st">Liste des médecins</h3>
			...
			<tbody> 
              ...
              <?php $i = 1; while($row_p = $p->fetch(PDO::FETCH_ASSOC)) : ?>  
				...
				<tr> 
    				...
    				<td><?php echo $row_p['nom_med']; ?></td> 
    			<td><?php echo $row_p['prenom_med']; ?></td> 
            	<td><?php echo $row_p['email']; ?></td>
              <td><?php echo "Dr. ".$row_p['specialite_med']." ".$row_p['prenom_med']; ?></td>
